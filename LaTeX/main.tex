...
Therefore the reward function that the agent is wishing to maximise the expected long term reward $E[Reward|\pi]$ for the optimal policy is: $$Reward = \sum_{t=0}^{\infty} \gamma^t r_{t+1}$$. 
